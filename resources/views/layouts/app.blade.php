                    ...
                    <ul class="navbar-nav">
                        @if (auth()->check())
                            ...
                            @role('admin')
                              ...
                              <li class="nav-item">
                                <a class="nav-link" href="{{ route('statistics.index') }}">Data Peminjaman</a>
                              </li>
                            @endrole
                            <li class="nav-item">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <a href="{{ route('password.edit') }}" class="dropdown-item"><i class="fa fa-btn fa-lock"></i> Ubah Password</a>
